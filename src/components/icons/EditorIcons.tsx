...
export const ScissorsIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12L21 21m-9-9L3 3" />
  </svg>
);
...
export const ArrowPathIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001a.75.75 0 01.75.75v3.523a3 3 0 01-2.22 2.872l-1.52.379a.75.75 0 00-.517.67l-.5 3.333a.75.75 0 01-1.472-.218l-.5-3.333a.75.75 0 00-.517-.67l-1.52-.379a3 3 0 01-2.22-2.872V10.099a.75.75 0 01.75-.75h4.992M15 7.5v.001M8.977 15.348H4.008v.001a.75.75 0 00-.75.75v3.523a3 3 0 002.22 2.872l1.52.379a.75.75 0 01.517.67l.5 3.333a.75.75 0 001.472-.218l.5-3.333a.75.75 0 01.517-.67l1.52-.379a3 3 0 002.22-2.872V16.1a.75.75 0 00-.75-.75H8.977M9 12.75v-.001" />
  </svg>
);
...
export const ClipboardIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.042A2.25 2.25 0 0113.5 9h-3a2.25 2.25 0 01-2.25-2.25V6.51c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5V8.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 011.927-.184" />
  </svg>
);